...
| P2-03 | P2 | schemas.py God Schema — was 1375 行/62 schema 单文件, v4.7 Slice A+B 后 __init__.py 降至 1216 行, 18 schema 提取至 import_export.py (120 行) + dogfood_lifecycle.py (89 行) | v2.x → v3.x | in_progress (v4.7) | v3.7+ |
